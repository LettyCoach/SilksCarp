...
@section('content')
    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"> <a href="{{ route('a2i.index') }}">お知らせ一覧</a> </li>
    ...
    <section class="section">
        <div class="card">
            <form action="{{ route('a2i.update', ['a2i' => $model->id]) }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <button type="button" class="btn btn-secondary"
                                    onclick="location.href='{{ route('a2i.index') }}'">
...
@section('js')
    <script src="{{ asset('assets/js/alarm/a2i.js') }}"></script>
@endsection
